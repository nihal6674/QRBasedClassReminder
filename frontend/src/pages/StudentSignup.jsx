...
const StudentSignup = () => {
  ...
  useEffect(() => {
    if (submitSuccess && signupResult) {
      toast.success('Registration successful! You will receive a reminder 7 days before your training.', {
        duration: 4000,
      });
    }
  ...
  useEffect(() => {
    if (submitError) {
      ...
      if (submitError.includes('already exists') || submitError.includes('unique constraint') || submitError.includes('Unique constraint')) {
